				  ...
				  struct touchscreen_properties *prop)
{
	...
	prop_max = touchscreen_get_prop_u32(dev, "touchscreen-size-x",
					    input_abs_get_max(input, axis) + 1,
					    &maximum);
	prop_fuzz = touchscreen_get_prop_u32(dev, "touchscreen-fuzz-x",
					     input_abs_get_fuzz(input, axis),
					     &fuzz);
	if (prop_max || prop_fuzz)
		touchscreen_set_params(input, axis, maximum - 1, fuzz);

	/* Axis Y Configuration */
	axis = multitouch ? ABS_MT_POSITION_Y : ABS_Y;
	prop_max = touchscreen_get_prop_u32(dev, "touchscreen-size-y",
					    input_abs_get_max(input, axis) + 1,
					    &maximum);
	prop_fuzz = touchscreen_get_prop_u32(dev, "touchscreen-fuzz-y",
					     input_abs_get_fuzz(input, axis),
					     &fuzz);
	if (prop_max || prop_fuzz)
		touchscreen_set_params(input, axis, maximum - 1, fuzz);
	...
	prop_max = touchscreen_get_prop_u32(dev, "touchscreen-max-pressure",
					    input_abs_get_max(input, axis),
					    &maximum);
	prop_fuzz = touchscreen_get_prop_u32(dev, "touchscreen-fuzz-pressure",
					     input_abs_get_fuzz(input, axis),
					     &fuzz);
	if (prop_max || prop_fuzz)
